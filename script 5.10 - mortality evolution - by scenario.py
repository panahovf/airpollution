...
df_concentration_cp = pd.read_excel('2 - output/script 4/s4.00 - 2.1 - annual concentration - country level - current policy.xlsx')
df_concentration_nz = pd.read_excel('2 - output/script 4/s4.00 - 2.2 - annual concentration - country level - net zero 1.5C.xlsx')
...
for i, df in enumerate(dataframes):
    ...
    new_exposure = np.arange(0, 200.0001, 0.0001)
    new_exposure = np.round(np.arange(0, 200.0001, 0.0001), 4)
