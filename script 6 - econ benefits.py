...
for country in countries:
    ...
    temp_data_benefit.append({'Country': country, 
                              'Cumulative economic benefit (mln $2019): 2035': value_2035_benefit,
                              'Cumulative economic benefit (mln $2019): 2050': value_2050_benefit,
                              })
