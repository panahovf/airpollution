...
# --------------
# MORTALITY DATA
df_annual_mortality_cp_total = pd.read_excel('2 - output/script 5/s5.30 - 1 - annual mortality by country - current policy - response upper.xlsx')
df_annual_mortality_nz_total = pd.read_excel('2 - output/script 5/s5.30 - 2 - annual mortality by country - nz 1.5c - response upper.xlsx')
...
# tables
df_benefit.to_excel('2 - output/script 6/s6.30_- 2.1 - table - economic benefits - response upper.xlsx', index = False)
df_death.to_excel('2 - output/script 6/s6.30_- 2.2 - table - avoided death - response upper.xlsx', index = False)
