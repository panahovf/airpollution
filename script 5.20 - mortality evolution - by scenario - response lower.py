...
df_annual_mortality_cp_total.to_excel('2 - output/script 5/s5.20 - 1 - annual mortality by country - current policy - response lower.xlsx', index = False)
df_annual_mortality_nz_total.to_excel('2 - output/script 5/s5.20 - 2 - annual mortality by country - nz 1.5c - response lower.xlsx', index = False)
